...
export const GreenTurtleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className || 'w-24 h-24 mx-auto mb-6 text-brand-accent drop-shadow-[0_0_8px_#4fd1c5]'}
  >
    <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" fill="currentColor" fillOpacity="0.15" />
    <path d="M10.15 3.2a9 9 0 0 1 3.7 0" />
    <path d="M3.2 10.15a9 9 0 0 0 0 3.7" />
    <path d="M13.85 20.8a9 9 0 0 1-3.7 0" />
    <path d="M20.8 13.85a9 9 0 0 0 0-3.7" />
    <path d="M12 2v20" />
    <path d="M2 12h20" />
